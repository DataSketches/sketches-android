 ...
 *
 * <p>The documentation for sketches-core's DoublesSketch applies here except that the size of an ItemsSketch
...
public final class ItemsSketch<T> {
   ...
   */
  public static <T> ItemsSketch<T> heapify(final Memory srcMem,
