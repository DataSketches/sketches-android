...
public class ItemsUnionTest {
  ...
  public void nullAndEmpty() {
    ItemsUnion<Integer> union = ItemsUnion.newInstance(Comparator.naturalOrder());
    ...
    final ItemsSketch<Integer> emptySk = ItemsSketch.newInstance(Comparator.naturalOrder());
    final ItemsSketch<Integer> validSk = ItemsSketch.newInstance(Comparator.naturalOrder());
    validSk.update(1);
    union.update(validSk);

    union = ItemsUnion.newInstance(result);
    ...
    union.update(ItemsSketch.newInstance(Comparator.naturalOrder()));
    result = union.getResult();
    Assert.assertTrue(result.isEmpty());
    Assert.assertEquals(result.getN(), 0);
    Assert.assertNull(result.getMinValue());
  ...
  public void nullAndEmptyInputsToNonEmptyUnion() {
    final ItemsUnion<Integer> union = ItemsUnion.newInstance(128, Comparator.naturalOrder());
    union.update(1);
    ItemsSketch<Integer> result = union.getResult();
  ...
  public void basedOnSketch() {
    ...
    final ItemsSketch<String> sketch = ItemsSketch.newInstance(comp);
    ItemsUnion<String> union = ItemsUnion.newInstance(sketch);
    union.reset();
    final byte[] byteArr = sketch.toByteArray(serDe);
    final Memory mem = Memory.wrap(byteArr);
    union = ItemsUnion.heapify(mem, comp, serDe);
  ...
  @Test
  public void sameK() {
    final ItemsUnion<Long> union = ItemsUnion.newInstance(128, Comparator.naturalOrder());
    ...
    final ItemsSketch<Long> sketch1 = ItemsSketch.newInstance(Comparator.naturalOrder());
    ...
    final ItemsSketch<Long> sketch2 = ItemsSketch.newInstance(Comparator.naturalOrder());
  ...
  public void differentK() {
    final ItemsUnion<Long> union = ItemsUnion.newInstance(512, Comparator.naturalOrder());
    ItemsSketch<Long> result = union.getResult();
    Assert.assertEquals(result.getN(), 0);
    Assert.assertNull(result.getMinValue());
    Assert.assertNull(result.getMaxValue());
    ...
    final ItemsSketch<Long> sketch1 = ItemsSketch.newInstance(256, Comparator.naturalOrder());
    ...
    final ItemsSketch<Long> sketch2 = ItemsSketch.newInstance(128, Comparator.naturalOrder());
  ...
  public void differentSmallerK() {
    final ItemsUnion<Long> union = ItemsUnion.newInstance(128, Comparator.naturalOrder());
    final ItemsSketch<Long> sketch1 = ItemsSketch.newInstance(64, Comparator.naturalOrder());
    union.update(sketch1);
  ...
  public void toStringCrudeCheck() {
    final ItemsUnion<String> union = ItemsUnion.newInstance(128, Comparator.naturalOrder());
    union.update("a");
  ...
  public void meNullOtherExactBiggerSmaller() {
    final ItemsUnion<Long> union = ItemsUnion.newInstance(16, Comparator.naturalOrder()); //me null
  ...
  public void meEmptyOtherExactBiggerSmaller() {
    final ItemsUnion<Long> union = ItemsUnion.newInstance(16, Comparator.naturalOrder()); //me null
    final ItemsSketch<Long> skEmpty = ItemsSketch.newInstance(64, Comparator.naturalOrder());
  ...
  public void checkToByteArray() {
    ...
    ItemsUnion<Long> union = ItemsUnion.newInstance(k, Comparator.naturalOrder());
    ...
    final Memory mem = Memory.wrap(byteArr);
    union = ItemsUnion.heapify(mem, Comparator.naturalOrder(), serDe);
  ...
  private static ItemsSketch<Long> buildIS(final int k, final int n, final int startV) {
    final ItemsSketch<Long> is = ItemsSketch.newInstance(k, Comparator.naturalOrder());
